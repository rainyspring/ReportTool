	...
	public static String getCellValue(Cell cell) {
		...
		case Cell.CELL_TYPE_FORMULA: {// 公式
			...
			if (HSSFDateUtil.isCellDateFormatted(cell)) {
				 ...
				 * evaluateInCell(Cell cell) Cell.CELL_TYPE_FORMULA
				 * Cell.CELL_TYPE_NUMBERIC SSFFormulaEvaluator evaluateAllFormu
				 * laCells(Workbook wb)
				 */
				if (cell.getDateCellValue() == null || "".equals(cell.getDateCellValue())) {
					return "";
				...
				// cellvalue =
				// String.valueOf(eval.evaluateFormulaCell(cell));
			}
