...
public class R {
	 ...
	 * 分页的正则
	 */
	public final static String SHEET_REGEX_CONTENT_PREFIX_STRING = "sheet.";
	public final static String SHEET_REGEX = "\\{sheet\\.([\\w]+)\\}";
	
	/**
	 * 对象属性的正则
	 */
	public final static String OBJECT_PROPERTY_REGEX_CONTENT_PREFIX = "(wl|ps|pl|fx|nde|kt|tb|pd|w|wr|ne|he)\\.";
	public final static String OBJECT_PROPERTY_REGEX = "\\{("+OBJECT_PROPERTY_REGEX_CONTENT_PREFIX+"[\\w]+)\\}";
	/**
	...
	public static class Layer{
		 ...
		 * 层的where sql部分
		 */
		public final static String WHERE_SQL = "whereSql";
		/**
		 * 层的orderBy Sql部分
		 */
		public final static String ORDER_BY_SQL = "orderBySql";
		/**
		 * 层的groupBy Sql部分
		 */
		public final static String GROUP_BY_SQL = "groupBySql";
	...
	public static class Sheet{
		 ...
		 * sheet分页的where sql部分
		 */
		public final static String WHERE_SQL = "sheetWhereSql";
		/**
		 * sheet分页的orderBy Sql部分
		 */
		public final static String ORDER_BY_SQL = "sheetOrderBySql";
		/**
		 * sheet分页的groupBy Sql部分
		 */
		public final static String GROUP_BY_SQL = "sheetGroupBySql";
